...
class ModelWorker(BaseModelWorker):
    ...
    def Mygenerate_stream_gate(self, params): #inspired by generate_stream_gate function present in this file 
        self.call_ct += 1
        ...
        try:
            for output in self.generate_stream_func(
                ...
                yield json.dumps(ret).encode('utf8')# + b"\0"
...
#Mygenerate_stream_gate
@app.post("/worker_generate_stream_custom")
async def api_generate_stream_custom(request: Request):
    params = await request.json()
    await acquire_worker_semaphore()
    generator = worker.Mygenerate_stream_gate(params)
