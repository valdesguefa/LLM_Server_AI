...
def load_model(device_type, model_id, model_basename=None):
    ...
    if model_basename is not None:
        ...
        print("Using AutoModelForCausalLM for full models and cuda")
        
        tokenizer = AutoTokenizer.from_pretrained(model_id)
        logging.info("Tokenizer loaded")

        model = AutoModelForCausalLM.from_pretrained(
            model_id, device_map="auto", torch_dtype=torch.float16, low_cpu_mem_usage=True, trust_remote_code=True#, load_in_8bit=True
        )
...
# model_id = "./models/lmsys_vicuna_7b_v1.3/"#"./models/TheBloke_vicuna_7B_1.1_HF/"#"./models/lmsys_vicuna_7b_v1.3/"#"./models/lmsys_vicuna_7b_v1.3/"#"TheBloke/WizardLM-7B-uncensored-GPTQ"
